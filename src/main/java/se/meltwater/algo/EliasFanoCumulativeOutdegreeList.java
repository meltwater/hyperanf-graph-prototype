...
public final class EliasFanoCumulativeOutdegreeList {
     ...
     * @param graph a graph.
     */
    public EliasFanoCumulativeOutdegreeList( final IGraph graph ) {
        this( graph, graph.getNumberOfArcs() );
    }

    /** Creates a cumulative outdegree list with no rounding mask.
     *
     * @param graph a graph.
     * @param numArcs the number of arcs in the graph (this parameter can be useful as some {@link IGraph} implementations
     * do not support {@link IGraph#getNumberOfArcs()} s()}).
     */
    public EliasFanoCumulativeOutdegreeList( final IGraph graph, final long numArcs ) {
     ...
     * @param graph a graph.
     * @param numArcs the number of arcs in the graph (this parameter can be useful as some {@link IGraph} implementations
     * do not support {@link IGraph#getNumberOfArcs()} ()}).
     ...
     */
    public EliasFanoCumulativeOutdegreeList(final IGraph graph, final long numArcs, final long roundingMask ) {
        ...
        final long length = numNodes = graph.getNumberOfNodes();
